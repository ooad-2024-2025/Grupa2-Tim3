...
namespace BookMyStyle.Controllers
{
    public class KorisnikController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("korisnikId,Ime,Prezime,Username,Password,tipFrizera,terminID")] Korisnik korisnik)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("korisnikId,Ime,Prezime,Username,Password,tipFrizera,terminID")] Korisnik korisnik)
        {
