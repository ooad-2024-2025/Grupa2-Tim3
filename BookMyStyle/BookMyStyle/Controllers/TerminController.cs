...
namespace BookMyStyle.Controllers
{
    public class TerminController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,NazivSalona,AdresaSalona,NazivFrizera,DatumIVrijeme")] Termin termin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,NazivSalona,AdresaSalona,NazivFrizera,DatumIVrijeme")] Termin termin)
        {
            if (id != termin.ID)
            {
                return NotFound();
