...
namespace BookMyStyle.Controllers
{
    public class ObavijestController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Tekst,DatumIVrijeme")] Obavijest obavijest)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Tekst,DatumIVrijeme")] Obavijest obavijest)
        {
            if (id != obavijest.ID)
            {
                return NotFound();
