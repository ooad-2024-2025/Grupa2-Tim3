...
namespace BookMyStyle.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            /// </summary>
            [Required]
            [StringLength(100, ErrorMessage = "{0} mora imati između {2} i {1} karaktera.", MinimumLength = 5)]
            ...
            [Compare("Password", ErrorMessage = "Nisu unesene iste lozinke.")]
            public string ConfirmPassword { get; set; }

            [Required]
            [StringLength(20, MinimumLength = 3, ErrorMessage = "Ime smije imati između 3 i 20 karaktera")]
            ...
            [Required]
            [StringLength(20, MinimumLength = 3, ErrorMessage = "Prezime smije imati između 3 i 20 karaktera")]
            [RegularExpression(@"^[a-zA-Z ]*$", ErrorMessage = "Dozvoljeno je korištenje velikih i malih slova i razmaka")]
